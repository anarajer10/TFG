...
// Gráfico de anillo SVG que muestra un % con color
...
function StatCard({ label, value, color, sub }) {
    ...
    return (
        ...
        >
            <Card style={{
                textAlign: "center",
                border: `1px solid ${hovered ? color + "88" : G.border}`,
                transition: "all 0.18s", transform: hovered ? "translateY(-6px)" : "none",
            }}>
                <div style={{
...
// Vista de panel de control con métricas globales de los modelos y estadísticas de la sesión actual
// history solo contiene los análisis de la sesión actual (no persiste entre recargas)
export default function DashboardPage({ history, onSelect, lang }) {
    ...
    return (
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px" }}>
            ...
            <h2 style={{
                fontFamily: fonts.display, fontWeight: 800, fontSize: 18, letterSpacing: "-0.02em",
            ...
            {metricas && (
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
                    {[
                        ...
                        return (
                            <div key={lang}
                                onMouseEnter={() => setHoveredModel(lang)}
                                onMouseLeave={() => setHoveredModel(null)}
                            >
                                <Card style={{
                                    border: `1px solid ${hoveredModel === lang ? G.accent + "88" : G.border}`,
                                    transition: "all 0.18s", transform: hoveredModel === lang ? "translateY(-6px)" : "none"
                                }}>
